...
$site_icon = $root . '/theme/blocksy-child/assets/images/site-icon-logo-512.png';
...
if ( false === strpos( $setup, 'get_site_icon_url' ) || false === strpos( $setup, 'site-icon-logo-512.png' ) ) { fwrite( STDERR, "Missing storefront site icon filter\n" ); exit( 1 ); }
